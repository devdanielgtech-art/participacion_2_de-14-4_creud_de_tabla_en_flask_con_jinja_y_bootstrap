...
# Listado de registros de la tabla personas
@app.route('/')
def index():
    conn = sqlite3.connect("kardex.db")
    # Permite manejar registros en forma de diccionarios, lo que facilita el acceso a los datos por nombre de columna en lugar de índices numéricos.
